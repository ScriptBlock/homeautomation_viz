	...
	!(__WEBPACK_AMD_DEFINE_ARRAY__ = [
	    ...
	    return SplunkVisualizationBase.extend({
	        ...
	        updateView: function(data, config) {
	            ...
	            var infoDevices = _.filter(dataRows, function(origData) { return origData["state"] != null });
	            _.each(infoDevices, function(data) {
	                                    var fg = L.featureGroup();
	                                    var fgPopupText = "";
	                                    var deviceName = data["name"];
	                                    console.log(deviceName);
	                                    var coords = eval(data["coords"]);
	                                    var shape = data["shape"];
	                                    var deviceRoom = data["deviceroom"];
	                                    var state = data["state"];
	                                    var markerColor = "black";
	                                    if(state == "on") { markerColor = "yellow" }
	                                    if(state == "open") { markerColor = "red" }
	                                    if(state == "closed") { markerColor = "lightblue" }
